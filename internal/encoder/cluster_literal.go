...
func HistogramBitCostDistanceLiteral(
	histogram *common.HistogramLiteral,
	candidate *common.HistogramLiteral,
) float64 {
...
func histogramReindexLiteral(
	out []common.HistogramLiteral,
	symbols []uint32,
	length uint,
	new_index_buf *[]uint32,
	reindex_tmp *[]common.HistogramLiteral,
) uint {
	...
	if cap(*reindex_tmp) < int(next_index) {
		*reindex_tmp = make([]common.HistogramLiteral, next_index)
	}
...
func ClusterHistogramsLiteral(
	...
	*out_size = histogramReindexLiteral(out, histogram_symbols, in_size, new_index_buf, reindex_tmp)
}
